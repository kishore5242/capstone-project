...
const TimeSelector = (props) => {
    ...
    return (
        <div className="reservation__time-selector">
            {(isMorning && (
                <TimeCapsule chooseTime={props.chooseTime} morning="Morning" slots={props.availableTimeSlots.morning} />
            )) ||
                (isAfternoon && (
                    <TimeCapsule
                        chooseTime={props.chooseTime}
                        morning="Afternoon"
                        slots={props.availableTimeSlots.afternoon}
                    />
                )) ||
                (isEvening && (
                    <TimeCapsule
                        chooseTime={props.chooseTime}
                        morning="Evening"
                        slots={props.availableTimeSlots.evening}
                    />
                ))}
        </div>
    );
